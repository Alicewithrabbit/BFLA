...
class TritonAttentionMetadata:
    ...
    # Optional CPU metadata for BFLA sparse pure-prefill masking.
    query_start_loc_cpu: torch.Tensor | None
    seq_lens_cpu: torch.Tensor | None
    bfla_allow_sparse_prefill: bool
...
class TritonAttentionMetadataBuilder(AttentionMetadataBuilder[TritonAttentionMetadata]):
    ...
    def build(
        ...
        attn_metadata = TritonAttentionMetadata(
            ...
            bfla_allow_sparse_prefill=common_attn_metadata.bfla_allow_sparse_prefill,
...
class TritonAttentionImpl(AttentionImpl):
    ...
    def forward(
        ...
        unified_attention(
            ...
            cu_seqlens_q_cpu=attn_metadata.query_start_loc_cpu,
            seq_lens_cpu=attn_metadata.seq_lens_cpu,
            bfla_common_prefix_len=attn_metadata.common_prefix_len,
            bfla_allow_sparse_prefill=attn_metadata.bfla_allow_sparse_prefill,
        )
