...
class CommonAttentionMetadata:
    ...
    """Whether experimental BFLA may sparsify pure prefill for this batch.
    This should stay false for requests whose prefill KV will be reused by
    multi-token decode or shared/prefix cache paths."""
